...
int Init(FEngine* InEngine,HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd)
{
	...
	if (ReturnValue != 0)
	{
		printf_s("[%i]Engine pre initialization error, check and initialization problem.", ReturnValue);
		return ReturnValue;
	}
	...
	if (ReturnValue != 0)
	{
		printf_s("[%i]Engine initialization error, please check the initialization problem.", ReturnValue);
		return ReturnValue;
	}
	...
	if (ReturnValue != 0)
	{
		printf_s("[%i]Engine post initialization error, please check the initialization problem.", ReturnValue);
		return ReturnValue;
	}
...
int Exit(FEngine* InEngine)
{
	...
	if (ReturnValue != 0)
	{
		printf_s("Engine pre exit failed.");
		return ReturnValue;
	}
	...
	if (ReturnValue != 0)
	{
		printf_s("[%i]Engine exit failed.", ReturnValue);
		return ReturnValue;
	}
	...
	if (ReturnValue != 0)
	{
		printf_s("[%i]Engine post exit failed.", ReturnValue);
		return ReturnValue;
	}
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance,PSTR cmdLine, int showCmd)
{
	...
	printf_s("[%i]The engine has exited.", ReturnValue);
	return ReturnValue;
}